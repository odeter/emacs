...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "all-the-icons-completion" '("all-the-icons-completion-completion-metadata-get")))

;;;***

;;;### (autoloads nil nil ("all-the-icons-completion-pkg.el") (0
;;;;;;  0 0 0))

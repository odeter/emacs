;;; company-quickhelp-terminal-autoloads.el --- automatically extracted autoloads
;;
;;; Code:
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "company-quickhelp-terminal" '("company-quickhelp-terminal--")))

...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cider-completion-context" '("cider-completion-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cider-docstring" '("cider-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cider-log" '("cider-")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "cider-xref-backend" '("cider--")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "nrepl-client" '("cider-" "emacs-bug-46284/when-27.1-windows-nt" "nrepl-")))

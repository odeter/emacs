...
#s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data ("straight" ("2023-10-16 15:17:34" ("emacs") (:type git :host github :repo "radian-software/straight.el" :files ("straight*.el") :branch "master" :package "straight" :local-repo "straight.el")) "org-elpa" ("2023-10-16 15:17:34" nil (:local-repo nil :package "org-elpa" :type git)) "melpa" ("2023-10-16 15:17:34" nil (:type git :host github :repo "melpa/melpa" :build nil :package "melpa" :local-repo "melpa")) "gnu-elpa-mirror" ("2023-10-16 15:17:34" nil (:type git :host github :repo "emacs-straight/gnu-elpa-mirror" :build nil :package "gnu-elpa-mirror" :local-repo "gnu-elpa-mirror")) "nongnu-elpa" ("2023-10-16 15:17:34" nil (:type git :repo "https://git.savannah.gnu.org/git/emacs/nongnu.git" :depth (full single-branch) :local-repo "nongnu-elpa" :build nil :package "nongnu-elpa")) "el-get" ("2023-10-16 15:17:34" nil (:type git :host github :repo "dimitri/el-get" :build nil :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :flavor melpa :package "el-get" :local-repo "el-get")) "emacsmirror-mirror" ("2023-10-16 15:17:34" nil (:type git :host github :repo "emacs-straight/emacsmirror-mirror" :build nil :package "emacsmirror-mirror" :local-repo "emacsmirror-mirror")) "chatgpt-arcana" ("2023-10-16 15:17:35" ("emacs") (:type git :host github :repo "CarlQLange/chatgpt-arcana.el" :files ("*.el") :package "chatgpt-arcana" :local-repo "chatgpt-arcana.el")) "use-package" ("2023-10-16 15:17:34" ("emacs" "bind-key") (:type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package" :package "use-package" :local-repo "use-package")) "bind-key" ("2023-10-16 15:17:34" ("emacs") (:flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :package "bind-key" :local-repo "use-package" :type git :repo "jwiegley/use-package" :host github))))
...
(fn &optional PACKAGE)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "straight" '("straight-"))) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "straight-ert-print-hack" '("+without-print-limits"))) (defvar straight-x-pinned-packages nil "List of pinned packages.") (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "straight-x" '("straight-x-"))) (provide 'straight-autoloads)) "chatgpt-arcana" ((chatgpt-arcana-autoloads chatgpt-arcana) (autoload 'chatgpt-arcana-replace-region "chatgpt-arcana" "Send PROMPT and selected region to ChatGPT and replace region with output.

(fn PROMPT)" t nil) (autoload 'chatgpt-arcana-insert "chatgpt-arcana" "Insert text at, before, or after the selected region or point.
...
(fn PROMPT &optional BEFORE IGNORE-REGION)" nil nil) (autoload 'chatgpt-arcana-insert-at-point-with-context "chatgpt-arcana" "Send PROMPT and context around point to ChatGPT and insert output at point.
NUM-LINES configues how many lines of context to send.

(fn PROMPT &optional NUM-LINES)" t nil) (autoload 'chatgpt-arcana-insert-after-region "chatgpt-arcana" "Send PROMPT and selected region to ChatGPT and insert output after region.

(fn PROMPT)" t nil) (autoload 'chatgpt-arcana-insert-before-region "chatgpt-arcana" "Send PROMPT and selected region to ChatGPT and insert output before region.

(fn PROMPT)" t nil) (autoload 'chatgpt-arcana-insert-at-point "chatgpt-arcana" "Send PROMPT to ChatGPT and insert output at point.

(fn PROMPT)" t nil) (autoload 'chatgpt-arcana-start-chat-with-system-prompt "chatgpt-arcana" "Start a chat with SYSTEM-PROMPT and PROMPT.
...
(fn SYSTEM-PROMPT PROMPT)" t nil) (autoload 'chatgpt-arcana-start-chat "chatgpt-arcana" "Start a chat with PROMPT.
...
(fn PROMPT)" t nil) (autoload 'chatgpt-arcana-resume-chat "chatgpt-arcana" "Resume a previous chat in the `chatgpt-arcana-chat-autosave-directory'.
...
If no matching files are found, the function will display an error message." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "chatgpt-arcana" '("chatgpt-arcana-"))) (provide 'chatgpt-arcana-autoloads)) "bind-key" ((bind-key-autoloads bind-key) (autoload 'bind-key "bind-key" "Bind KEY-NAME to COMMAND in KEYMAP (`global-map' if not passed).
...
(fn &rest ARGS)" nil t) (autoload 'describe-personal-keybindings "bind-key" "Display all the personal keybindings defined by `bind-key'." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "bind-key" '("bind-key" "compare-keybindings" "get-binding-description" "override-global-m" "personal-keybindings"))) (provide 'bind-key-autoloads)) "use-package" ((use-package-autoloads use-package-ensure use-package-diminish use-package use-package-core use-package-lint use-package-delight use-package-bind-key use-package-jump) (autoload 'use-package-autoload-keymap "use-package-bind-key" "Load PACKAGE and bind key sequence invoking this function to KEYMAP-SYMBOL.
...
with the specified `:load-path' the module cannot be found." t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "use-package-lint" '("use-package-lint-declaration"))) (provide 'use-package-autoloads))))

#s(hash-table size 65 test eq rehash-size 1.5 rehash-threshold 0.8125 data (org-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 15 "melpa" nil "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" nil "emacsmirror-mirror" nil "straight" nil "chatgpt-arcana" nil "use-package" nil "bind-key" nil)) melpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "gnu-elpa-mirror" nil "nongnu-elpa" nil "el-get" (el-get :type git :flavor melpa :files ("*.el" ("recipes" "recipes/el-get.rcp") "methods" "el-get-pkg.el") :host github :repo "dimitri/el-get") "emacsmirror-mirror" nil "straight" nil "chatgpt-arcana" nil "use-package" (use-package :type git :flavor melpa :files (:defaults (:exclude "bind-key.el" "bind-chord.el" "use-package-chords.el" "use-package-ensure-system-package.el") "use-package-pkg.el") :host github :repo "jwiegley/use-package") "bind-key" (bind-key :type git :flavor melpa :files ("bind-key.el" "bind-key-pkg.el") :host github :repo "jwiegley/use-package"))) gnu-elpa-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 3 "nongnu-elpa" nil "emacsmirror-mirror" nil "straight" nil "chatgpt-arcana" nil)) nongnu-elpa #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 4 "emacsmirror-mirror" nil "straight" nil "chatgpt-arcana" nil)) el-get #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "emacsmirror-mirror" nil "straight" nil "chatgpt-arcana" nil)) emacsmirror-mirror #s(hash-table size 65 test equal rehash-size 1.5 rehash-threshold 0.8125 data (version 2 "straight" (straight :type git :host github :repo "emacsmirror/straight") "chatgpt-arcana" nil))))

("org-elpa" "melpa" "gnu-elpa-mirror" "nongnu-elpa" "el-get" "emacsmirror-mirror" "straight" "emacs" "use-package" "bind-key" "chatgpt-arcana")
